#import "BytedancePangolinPlugin.h"

#import <BUAdSDK/BUAdSDK.h>

@interface BytedancePangolinPlugin ()<BUNativeExpressRewardedVideoAdDelegate,BUSplashAdDelegate,
...
@implementation BytedancePangolinPlugin

FlutterMethodChannel* globalMethodChannel;

+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    FlutterMethodChannel* channel = [FlutterMethodChannel
                                     methodChannelWithName:@"bytedance_pangolin"
                                     binaryMessenger:[registrar messenger]];
    BytedancePangolinPlugin* instance = [[BytedancePangolinPlugin alloc] init];
