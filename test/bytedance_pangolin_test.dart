...
void main() {
  final BytedancePangolinPlatform initialPlatform = BytedancePangolinPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockBytedancePangolinPlatform fakePlatform = MockBytedancePangolinPlatform();
